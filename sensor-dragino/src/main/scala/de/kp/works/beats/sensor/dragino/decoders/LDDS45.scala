...
object LDDS45 extends BaseDecoder {
  /*
   * The Dragino LDDS45 is a Distance Detection Sensor and
   * is used to measure the distance between the sensor and
   * a flat object.
   *
   * The distance detection sensor is a module that uses
   * ultrasonic sensing technology for distance measurement,
   *  and temperature compensation is performed internally
   * to improve the reliability of data.
   *
   * The LDDS45 can be applied to scenarios such as horizontal
