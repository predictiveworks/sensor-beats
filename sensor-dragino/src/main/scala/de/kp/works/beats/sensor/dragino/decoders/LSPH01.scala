...
object LSPH01 extends BaseDecoder {
  /*
   * he Dragino LSPH01 is a LoRaWAN Soil pH Sensor for
   * IoT of Agriculture. It is designed to measure the
   * soil PH and soil temperature, to analyze the soil
   * acid or alkali level.
   */
  override def decode(bytes: Array[Int], fport: Int): JsonObject = {
    ...
    fport match {
      case 2 =>
        ...
        // PH1_SOIL
        val ph1_soil = (bytes(4) << 8 | bytes(5)).toDouble / 100
        decoded.addProperty("PH1_SOIL", ph1_soil)
