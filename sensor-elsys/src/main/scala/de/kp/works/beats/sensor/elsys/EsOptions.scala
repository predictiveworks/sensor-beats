...
/**
 * Wrapper for Elsys sensors specific
 * service configuration
 */
class EsOptions(config:EsConf) {
  /**
   ...
   * Elsys product name; in case of an unsupported
   * sensor, an exception is thrown
   */
  def getProduct:EsProduct =
    config.getProduct
  /**
  ...
  def toBoard:BoardOptions[EsConf] =
    new BoardOptions[EsConf](config)

  def toFiware:FiwareOptions[EsConf] =
    new FiwareOptions[EsConf](config)
  /**
   * The Helium configuration to access the Helium
   * network, which is one of the input channels of
   * a Sensor Beat
   */
  def toHelium:HeliumOptions[EsConf] =
    new HeliumOptions[EsConf](config)
  /**
   * The Loriot configuration to access the Loriot
   * network, which is one of the input channels of
   * a Sensor Beat
   */
  def toLoriot:LoriotOptions[EsConf] =
    new LoriotOptions[EsConf](config)
  /**
   * The ThingsStack configuration to access The Things
   * Network, which is one of the input channels of a
   * Sensor Beat
   */
  def toStack:StackOptions[EsConf] =
    new StackOptions[EsConf](config)
