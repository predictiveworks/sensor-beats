...
/**
 * Wrapper for Netvox sensors specific
 * service configuration
 */
class NvOptions(config:NvConf) {
  /**
   ...
   * Netvox product name; in case of an
   * unsupported sensor, an exception is thrown
   */
  def getProduct:NvProduct =
    config.getProduct
  /**
  ...
  def toBoard:BoardOptions[NvConf] =
    new BoardOptions[NvConf](config)

  def toFiware:FiwareOptions[NvConf] =
    new FiwareOptions[NvConf](config)
  /**
   * The Helium configuration to access the Helium
   * network, which is one of the input channels of
   * a Sensor Beat
   */
  def toHelium:HeliumOptions[NvConf] =
    new HeliumOptions[NvConf](config)
  /**
   * The Loriot configuration to access the Loriot
   * network, which is one of the input channels of
   * a Sensor Beat
   */
  def toLoriot:LoriotOptions[NvConf] =
    new LoriotOptions[NvConf](config)
  /**
   * The ThingsStack configuration to access The Things
   * Network, which is one of the input channels of a
   * Sensor Beat
   */
  def toStack:StackOptions[NvConf] =
    new StackOptions[NvConf](config)
