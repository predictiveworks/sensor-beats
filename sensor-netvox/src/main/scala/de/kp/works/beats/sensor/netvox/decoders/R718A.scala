...
object R718A extends BaseDecoder {
  /*
   * R718A is measures temperature and humidity at
   * low temperature environment.
   *
   * R718A can be used in domestic and commercial
   * refrigerators to store and transport food, medicines,
   * flowers and other perishable goods, on the walls or
   * in logistics refrigerators.
   */
