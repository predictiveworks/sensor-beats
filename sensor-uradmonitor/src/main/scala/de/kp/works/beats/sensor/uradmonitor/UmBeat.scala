...
object UmBeat extends UmLogging {

  val programName: String = "UmBeat"
  val programDesc: String = "Digital twin of an Urad Monitor sensor."

  private val config = UmConf.getInstance
  private val line = s"------------------------------------------------"
  ...
  def main(args:Array[String]):Unit = {
    ...
    try {
      ...
      val service = new UmService(config)
      service.start()
